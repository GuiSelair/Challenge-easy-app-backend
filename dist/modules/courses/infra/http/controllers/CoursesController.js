...
var CoursesController = /** @class */ (function () {
    ...
    CoursesController.prototype.show = function (request, response, _) {
        return __awaiter(this, void 0, void 0, function () {
            var coursesRepository, allCourses, courses;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        coursesRepository = typeorm_1.getRepository(Course_1.default);
                        return [4 /*yield*/, coursesRepository.find({
                                select: ['id_curso', 'descricao']
                            })];
                    case 1:
                        allCourses = _a.sent();
                        courses = allCourses.map(function (course) { return (__assign(__assign({}, course), { id_curso: Number(course.id_curso / 1000000) })); });
    ...
    CoursesController.prototype.index = function (request, response, _) {
        return __awaiter(this, void 0, void 0, function () {
            var coursesRepository, id, transformIDToString, findCourse, transformIDToNumber;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        coursesRepository = typeorm_1.getRepository(Course_1.default);
                        ...
                        return [4 /*yield*/, coursesRepository.findOne({
                                where: {
                    ...
                    case 1:
                        ...
                        transformIDToNumber = Number(findCourse.id_curso) / 1000000;
